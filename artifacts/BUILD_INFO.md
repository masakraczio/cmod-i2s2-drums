...
- `cmod-i2s2-drums-webui-0.4.5.zip`
- `midi-esp32-c3-supermini-adapter-0.4.5.zip`
...
The ESP32-C3 SuperMini MIDI DIN input diagnostic with raw-byte and GPIO20 edge counters was compiled and uploaded to COM7 with Arduino CLI 1.5.1 and esp32 core 3.3.10.
