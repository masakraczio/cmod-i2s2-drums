...
- `cmod-i2s2-drums-webui-0.4.7.zip`
- `midi-esp32-c3-supermini-adapter-0.4.7.zip`
- `teensy41-midi-din-test-0.4.7.zip`
...
The Teensy 4.1 MIDI DIN input diagnostic was built with Arduino CLI 1.5.1 and PJRC Teensy core 1.62.0, then uploaded to the detected Teensy 4.1 USB port.
